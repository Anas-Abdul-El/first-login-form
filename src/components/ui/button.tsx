 ...
 * Defines all available button variants and sizes.
 */
 ...
 * Can render as a button element or as a child component (using Slot).
 * 
 ...
 * @param {boolean} props.asChild - If true, renders as child component instead of button element
...
function Button({
  ...
  /** Component to render - either Slot or button element */
